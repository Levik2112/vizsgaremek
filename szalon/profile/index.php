...
?>
<?php if (isset($_GET['password_sent'])): ?>
<div class="alert alert-success text-center mb-3">
    📧 Ha az email küldés sikeres volt, megkaptad a jelszó módosító linket.
</div>
<?php endif; ?>
...
<form method="post" action="request_email.php">
    <input class="form-control mb-3" name="new_email"
           placeholder="Új email cím" required>
...
<a href="/szalon/profile/profile_forgot_password.php" class="btn-main w-75 profile-password-btn">
